...
- [ ] **Titular del copyright.** `LICENSE` (apéndice) y `NOTICE` dicen "The authors of this
      repository (see README)" y el README no nombra a nadie. Para una publicación Apache 2.0
